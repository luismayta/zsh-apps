...
:Version: 0.0.0
:Web: https://github.com/luismayta/zsh-apps
:Download: https://github.com/luismayta/zsh-apps
:Source: https://github.com/luismayta/zsh-apps
:Keywords: zsh-apps
...
2. Clone the plugin
    ``bash   git clone https://github.com/luismayta/zsh-apps``\ bash
3. Edit your ``.zshrc`` and add
    ``plugins=( ... zsh-apps )`` to your list of
    plugins
...
2. Either open a new terminal to force zsh to load the new plugin, or
    run ``antibody bundle luismayta/zsh-apps`` in a
    running zsh session.
3. Enjoy!
...
.. |Build Status| image:: https://travis-ci.org/luismayta/zsh-apps.svg
    :target: https://travis-ci.org/luismayta/zsh-apps
.. |GitHub issues| image:: https://img.shields.io/github/issues/luismayta/zsh-apps.svg
    :target: https://github.com/luismayta/zsh-apps/issues
