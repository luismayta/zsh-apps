<!-- Space: Projects -->
<!-- Parent: ZshApps -->
<!-- Title: Contributing GithubFlow ZshApps -->
<!-- Label: ZshApps -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-apps project on [GitHub](https://github.com/luismayta/zsh-apps), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/zsh-apps/pulls).
...
To follow the instructions in this guide and start contributing to zsh-apps project on GitHub:
...
```bash
git remote add upstream  https://github.com/luismayta/zsh-apps.git
```

Now your **upstream** points to **luismayta/zsh-apps**.
...
git fetch upstream # assuming upstream is luismayta/zsh-apps
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/zsh-apps/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
